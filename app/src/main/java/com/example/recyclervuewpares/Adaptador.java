...
*/
    ...
    */
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        String nombre = listaClientes.get(position).getNombre();
        String age = listaClientes.get(position).getAge();
        holder.txnombre.setText(nombre);
    ...
    */
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        private TextView txnombre, txage;


        public ViewHolder(View v) {
            super(v);
            txnombre = (TextView) v.findViewById(R.id.txtNombre);
            txage = (TextView) v.findViewById(R.id.txtAge);
        }
    }
}
